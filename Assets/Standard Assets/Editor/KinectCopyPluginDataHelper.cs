...
public static class KinectCopyPluginDataHelper
{
    ...
    private static readonly Dictionary<BuildTarget, string> TargetToDirName = new Dictionary<BuildTarget, string>
    {
    ...
    {
        string subDirName;
        if (!TargetToDirName.TryGetValue(target, out subDirName)) return;
        ...
        var srcPluginsDir = Application.dataPath + separator + PluginsDirName + separator + subDirName + separator +
                            subDirToCopy + separator;
