...

    {
        ...
        public FrameDescription FrameDescription
        {
            get
            {
                ...
                var objectPointer = Windows_Kinect_InfraredFrameSource_get_FrameDescription(_pNative);
        ...
        public KinectSensor KinectSensor
        {
            get
            {
                ...
                var objectPointer = Windows_Kinect_InfraredFrameSource_get_KinectSensor(_pNative);
                ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero) return null;
        ...
        private void Dispose(bool disposing)
        {
            ...
            NativeObjectCache.RemoveObject<InfraredFrameSource>(_pNative);
        ...
        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern RootSystem.IntPtr Windows_Kinect_InfraredFrameSource_get_FrameDescription(
        ...
        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern RootSystem.IntPtr Windows_Kinect_InfraredFrameSource_get_KinectSensor(
            RootSystem.IntPtr pNative);
            ...
            RootSystem.IntPtr pNative)
        {
            ...
            lock (callbackList)
            {
                var objThis = NativeObjectCache.GetObject<InfraredFrameSource>(pNative);
        ...
        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern void Windows_Kinect_InfraredFrameSource_add_FrameCaptured(RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<FrameCapturedEventArgs> FrameCaptured
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_InfraredFrameSource_add_FrameCaptured(_pNative,
        ...
        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern void Windows_Kinect_InfraredFrameSource_add_PropertyChanged(RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<PropertyChangedEventArgs> PropertyChanged
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 0)
                    {
                        Windows_Kinect_InfraredFrameSource_add_PropertyChanged(_pNative,
        ...
        private static extern RootSystem.IntPtr
            Windows_Kinect_InfraredFrameSource_OpenReader(RootSystem.IntPtr pNative);

        public InfraredFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero) throw new RootSystem.ObjectDisposedException("InfraredFrameSource");

            var objectPointer = Windows_Kinect_InfraredFrameSource_OpenReader(_pNative);
            ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero) return null;

            return NativeObjectCache.CreateOrGetObject(objectPointer,
                n => new InfraredFrameReader(n));
        }
