...

    {
        ...
        public FrameDescription FrameDescription
        {
            get
            {
                ...
                var objectPointer =
                    Windows_Kinect_LongExposureInfraredFrameSource_get_FrameDescription(_pNative);
        ...
        public KinectSensor KinectSensor
        {
            get
            {
                ...
                var objectPointer =
                    Windows_Kinect_LongExposureInfraredFrameSource_get_KinectSensor(_pNative);
                ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero) return null;
        ...
        private static extern void Windows_Kinect_LongExposureInfraredFrameSource_ReleaseObject(
            ref RootSystem.IntPtr pNative);

        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern void Windows_Kinect_LongExposureInfraredFrameSource_AddRefObject(
            ref RootSystem.IntPtr pNative);
        ...
        private void Dispose(bool disposing)
        {
            ...
            NativeObjectCache.RemoveObject<LongExposureInfraredFrameSource>(_pNative);
        ...
        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern RootSystem.IntPtr Windows_Kinect_LongExposureInfraredFrameSource_get_FrameDescription(
            RootSystem.IntPtr pNative);

        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern bool Windows_Kinect_LongExposureInfraredFrameSource_get_IsActive(
            RootSystem.IntPtr pNative);

        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern RootSystem.IntPtr Windows_Kinect_LongExposureInfraredFrameSource_get_KinectSensor(
            RootSystem.IntPtr pNative);
            ...
            RootSystem.IntPtr pNative)
        {
            ...
            lock (callbackList)
            {
                var objThis = NativeObjectCache.GetObject<LongExposureInfraredFrameSource>(pNative);
        ...
        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern void Windows_Kinect_LongExposureInfraredFrameSource_add_FrameCaptured(
            RootSystem.IntPtr pNative, _Windows_Kinect_FrameCapturedEventArgs_Delegate eventCallback, bool unsubscribe);
        ...
        public event RootSystem.EventHandler<FrameCapturedEventArgs> FrameCaptured
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_LongExposureInfraredFrameSource_add_FrameCaptured(_pNative,
        ...
        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern void Windows_Kinect_LongExposureInfraredFrameSource_add_PropertyChanged(
        ...
        public event RootSystem.EventHandler<PropertyChangedEventArgs> PropertyChanged
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 0)
                    {
                        Windows_Kinect_LongExposureInfraredFrameSource_add_PropertyChanged(_pNative,
        ...
        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern RootSystem.IntPtr Windows_Kinect_LongExposureInfraredFrameSource_OpenReader(
            RootSystem.IntPtr pNative);
        ...
        public LongExposureInfraredFrameReader OpenReader()
        {
            ...
            var objectPointer = Windows_Kinect_LongExposureInfraredFrameSource_OpenReader(_pNative);
            ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero) return null;

            return NativeObjectCache.CreateOrGetObject(
                objectPointer, n => new LongExposureInfraredFrameReader(n));
        }
