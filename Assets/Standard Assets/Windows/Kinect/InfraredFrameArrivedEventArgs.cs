...
namespace Windows.Kinect
{
    ...
    //
    public sealed class InfraredFrameArrivedEventArgs : RootSystem.EventArgs, INativeWrapper

    {
        ...
        public InfraredFrameReference FrameReference
        {
            get
            {
                ...
                var objectPointer =
                    Windows_Kinect_InfraredFrameArrivedEventArgs_get_FrameReference(_pNative);
        ...
        private static extern void Windows_Kinect_InfraredFrameArrivedEventArgs_ReleaseObject(
            ref RootSystem.IntPtr pNative);

        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern void Windows_Kinect_InfraredFrameArrivedEventArgs_AddRefObject(
            ref RootSystem.IntPtr pNative);
        ...
        private void Dispose(bool disposing)
        {
            ...
            NativeObjectCache.RemoveObject<InfraredFrameArrivedEventArgs>(_pNative);
        ...
        [DllImport("KinectUnityAddin",
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        private static extern RootSystem.IntPtr Windows_Kinect_InfraredFrameArrivedEventArgs_get_FrameReference(
